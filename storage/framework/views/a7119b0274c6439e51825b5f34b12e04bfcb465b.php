...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('assets/examples/css/pages/login-v2.css')); ?>">
  <!-- Fonts -->
  ...
  <!--[if lt IE 8]>
        ...
        <div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
          <div class="page-content">
            <div class="page-brand-info">
              <div class="brand">
                <img class="brand-img" src="<?php echo e(asset('assets/images/logo@2x.png')); ?>" alt="...">
            ...
            <div class="page-login-main animation-slide-right animation-duration-1" style="background-color: hsla(255, 0%, 0%, 0.4); color: white;">
              <div class="brand hidden-md-up">
                <img class="brand-img" src="<?php echo e(asset('assets/images/logo-blue@2x.png')); ?>" alt="...">
              ...
              <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                ...
                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                  ...
                  <input type="email" class="form-control" id="inputEmail" name="email" value="<?php echo e(old('email')); ?>" placeholder="Email">
        ...
        <script>
          Config.set('assets', '<?php echo e(asset('assets')); ?>';
        </script>
        <!-- Page -->
