	...
	<div class="ribbon ribbon-clip ribbon-reverse ribbon-success" id="bioribbon">
		...
		<div id="biodata">
			...
			<form autocomplete="off">
				<input type="hidden" name="_bio_csrf" id="_bio_csrf" value="<?php echo e(csrf_token()); ?>">
			...
			<?php if(Auth::user()->sex == 'M' || Auth::user()->sex == 'F'): ?>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row row-lg">
						...
						<input type="hidden" name="_edit_bio_csrf" id="_edit_bio_csrf" value="<?php echo e(csrf_token()); ?>">
						<div class="col-md-12">
							<div class="col-md-6">
								<div class="form-group form-material floating" data-plugin="formMaterial">
							...
							<div class="col-md-6">
								<div class="form-group form-material floating" data-plugin="formMaterial">
									<select class="form-control" id="edit_sex" name="edit_sex">
										<option value="M" <?php if($bios->sex == "M"): ?> selected <?php endif; ?>>Male</option>
										<option value="F" <?php if($bios->sex == "F"): ?> selected <?php endif; ?>>Female</option>
									</select>
									<label class="floating-label">Sex</label>
								</div>
							</div>
						...
						<div class="col-md-12">
							<div class="col-md-6">
								<div class="form-group form-material floating" data-plugin="formMaterial">
									<input type="text" class="form-control" name="edit_dob" id="edit_dob" required="required" data-plugin="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo e($bios->dob); ?>">
									<label class="floating-label">Date of Birth</label>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group form-material floating" data-plugin="formMaterial">
									<input type="text" class="form-control" name="edit_phone" id="edit_phone" required="required" value="<?php echo e($bios->phone_num); ?>">
									<label class="floating-label">Phone Number*</label>
								</div>
							</div>
						</div>
						<div class="col-md-12">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="radio-custom radio-default radio-inline">
										<?php if($bios->marital_status == "married"): ?>
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="form-group form-material floating" data-plugin="formMaterial">
									<input type="text" class="form-control" name="edit_lga" id="edit_lga" value="<?php echo e($bios->lga); ?>">
									<label class="floating-label">Local Government Area*</label>
								</div>
							</div>
						</div>
