                  ...
                  <table class="table table-hover tabletable-striped dataTable" id="data_table">
                      ...
                      <tbody> 
                            ...
                            <tr>
                                ...
                                <td><?php if($training->job_role==Config::get('constants.roles.Employee')): ?> <?php echo e('Employee'); ?> <?php endif; ?></td>
                                ...
                                <td class="actions"><a onclick="fnSubmit(<?php echo e($training->id); ?>)"><i class="btn btn-sm btn-primary waves-effect icon fa-plus" aria-hidden="true"></i></a></td>
