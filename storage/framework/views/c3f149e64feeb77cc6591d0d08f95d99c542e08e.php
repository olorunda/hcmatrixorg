<?php echo $__env->make('layouts.header', ['page_title' => 'Daily Attendances'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      ...
      <div class="panel">
        <div class="panel-body container-fluid">
          ...
          <div class="calendar-container">
            ...
            <?php elseif(Auth::user()->role==Config::get('constants.roles.People_Manager')): ?>
  ...
  <div class="modal fade" id="EditEventDetails" aria-hidden="true" aria-labelledby="EditEventDetails"
        role="dialog" tabindex="-1">
          <div class="modal-dialog">
            <form class="modal-content form-horizontal" name="fmupdate" id="fmupdate" action="<?php echo e(url('daily-attendance-emp-update')); ?>" method="post" role="form">
                 <?php echo e(csrf_field()); ?>
...
<script src="<?php echo e(URL::asset('js/DailyAttendanceEmpCalendar.js')); ?>"></script>
<script src="<?php echo e(URL::asset('js/bootstrap-timepicker.js')); ?>"></script>
<script>  
...
//page redirect
  ...
  {
      if(type == 'admin') {
        window.location = "<?php echo e(url('employee/list')); ?>";
    } else if(type == 'poepleManager') {
        window.location = "<?php echo e(url('employee/list')); ?>";
    } else {
        window.location = "<?php echo e(url('/daily-attendance')); ?>";
    }
  }
...
function fnsubmit()
  {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('daily-attendance-emp-update')); ?>",
  ...
  function savesubmit()
  {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('daily-attendance-emp-save')); ?>",
