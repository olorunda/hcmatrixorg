    ...
    <!--<script type="text/javascript">
      $(function(){
        $("#searchForm").submit(function(e){
          ...
          window.location = <?php echo e(Request::url()); ?> +"/available_jobs/joblist/filter/?experience=" + experience + "/&jobtype=" + jobtype + "/&emptype=" + emptype + "/&deptfil=" + deptfil + "/&dateposted=" + dateposted + "/&location=" + location;
        });
      })
    </script>-->
