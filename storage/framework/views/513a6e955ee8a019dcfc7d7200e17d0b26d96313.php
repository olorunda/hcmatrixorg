    ...
    <li data-plugin="appear" data-animate="scale-up">
      <div class="">
        <div class="category">
          ...
          <button type="button" onclick="urlChange('<?php echo e(url('employeet/2')); ?>')" class="btn btn-outline btn-info ladda-button" data-style="expand-left" data-plugin="ladda" data-type="progress">
    ...
    <li data-plugin="appear" data-animate="slide-right">
      <div class="">
        <div class="category">
          ...
          <button type="button" class="btn btn-outline btn-warning ladda-button" data-style="expand-left" data-plugin="ladda" data-type="progress" onclick="urlChange('<?php echo e(url('employeet/1')); ?>')">
            <span class="ladda-label"><i class="icon wb-plus m-r-10" aria-hidden="true"></i>More</span>
          </button>
        </div>
      </div>
    ...
    <li data-plugin="appear" data-animate="slide-top">
      <div class="">
        <div class="category">
          ...
          <button onclick="urlChange('<?php echo e(url('employeet/3')); ?>')" type="button" class="btn btn-outline btn-success ladda-button" data-style="expand-left" data-plugin="ladda" data-type="progress">
            <span class="ladda-label"><i class="icon wb-plus m-r-10" aria-hidden="true"></i>More</span>
          </button>
        </div>
      </div>
    ...
    <li data-plugin="appear" data-animate="slide-bottom">
      <div class="">
        <div class="category">
          ...
          <button onclick="urlChange('<?php echo e(url('employeet/4')); ?>')" type="button" class="btn btn-outline btn-primary ladda-button" data-style="expand-left" data-plugin="ladda" data-type="progress">
            <span class="ladda-label"><i class="icon wb-plus m-r-10" aria-hidden="true"></i>More</span>
          </button>
        </div>
      </div>
