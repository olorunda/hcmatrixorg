                  ...
                  <table class="table table-hover tabletable-striped dataTable" id="data_table">
                      ...
                      <tbody> 
                            ...
                            <tr>
                                ...
                                <?php if(Auth::user()->role==Config::get('constants.roles.Admin_User')): ?>
                                  <td class="actions">
                                      <?php if(isset( $employee->basicpay)): ?>
                                      <a onClick="fnEditBasicpay('<?php echo e($employee->grade); ?>', '<?php echo e($employee->basicpay); ?>')"><i class="btn btn-sm btn-primary waves-effect icon fa-edit" aria-hidden="true" title="Edit"></i></a>
                                      <?php else: ?>
                                      <a onClick="fnAddBasicpay('<?php echo e($employee->grade); ?>')"><i class="btn btn-sm btn-warning waves-effect icon fa-plus" aria-hidden="true" title="Add"></i></a>
                                      <?php endif; ?>
                                  </td>
                              <?php endif; ?>
                            </tr>                            
