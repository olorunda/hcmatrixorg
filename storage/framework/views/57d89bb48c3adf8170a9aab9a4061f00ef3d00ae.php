...
<div class="row row-lg">
  <div class="col-md-12 col-xs-12">
    <div class="panel panel-bordered" style="margin-bottom: 4px;">
      ...
      <div class="panel-body">
        <div class="panel-group panel-group-simple" id="siteMegaAccordion1<?php echo e(Auth::user()->id); ?>" aria-multiselectable="true" role="tablist">
          <?php $__currentLoopData = $pilots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pilot): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
          <div class="panel">
            <div class="panel-heading" id="pilotHeadingModal1<?php echo e(Auth::user()->id); ?><?php echo e($pilot->id); ?>" role="tab">
              <a class="panel-title" data-toggle="collapse" href="#pilotcollapsModal1<?php echo e(Auth::user()->id); ?><?php echo e($pilot->id); ?>" data-parent="#siteMegaAccordion1<?php echo e(Auth::user()->id); ?>" aria-expanded="false" aria-controls="pilotcollapsModal1<?php echo e(Auth::user()->id); ?><?php echo e($pilot->id); ?>">
                <h5 class="text-warning">Commitment</h5>
              </a>
              <span class="text-default">
                <?php echo e($pilot->commitment); ?>
            ...
            <div class="panel-collapse collapse" id="pilotcollapsModal1<?php echo e(Auth::user()->id); ?><?php echo e($pilot->id); ?>" aria-labelledby="pilotHeadingModal1<?php echo e(Auth::user()->id); ?><?php echo e($pilot->id); ?>" role="tabpanel">
              <div class="panel-body">
                <div class="row">
                  <div class="col-md-2 col-xs-12">
                    <h5>Objectvie</h5>
                  ...
                  <div class="col-md-10 col-xs-12">
                    <ul>
                      <li>
                        ...
                        <br>
                        <p>
                          <a href="javascript:void(0)" onclick="editComm('cma1<?php echo e($j); ?><?php echo e(Auth::user()->id); ?>')" id="edit"><i class="icon wb-edit"></i></a>
                          <i class="hide" id="status<?php echo e($j); ?>"></i>
                        </p>
                        <div class="click2edit" id="cma1<?php echo e($j); ?><?php echo e(Auth::user()->id); ?>" empid="<?php echo e(Auth::user()->id); ?>" goalid="<?php echo e($pilot->id); ?>" style="word-wrap: break-word;">
                          <?php if(count($cmt) > 0): ?>
                          <?php if($cmt->lm_comment != NULL): ?>
                          <?php echo e($cmt->lm_comment); ?>
