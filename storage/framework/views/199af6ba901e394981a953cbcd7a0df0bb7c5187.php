              ...
              <div class="table-responsive">
                <table class="table table-hover" data-role="content" data-plugin="selectable" data-row-selectable="true">
                  ...
                  <tbody>
                    ...
                    <td>
				<a role="button" target="_blank" href="<?php echo e(asset('storage')); ?>/<?php echo e($document->path); ?>" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip" data-original-title="View">
