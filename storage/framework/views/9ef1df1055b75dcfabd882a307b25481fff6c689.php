<?php echo $__env->make('layouts.header', ['page_title' => 'Vacancy List'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <!-- Page -->
  <div class="page">
              ...
              <div class="card card-shadow card-responsive" id="widgetTimeline">
                <div class="card-block p-0">
                  ...
                  <table class="table table-hover tabletable-striped dataTable" id="data_table">
                      ...
                      <tbody> 
                          <?php $sno = 1; ?>
                            <?php $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>  
                            <tr>  
                                <td><?php echo e($sno++); ?> </td>                             
                                <td><?php echo e($vacancy->vacant_position); ?></td>
                                <td><?php echo e($vacancy->instead_of_whom); ?></td>
                                <td><p><?php echo e($vacancy->description); ?></p></td>
                                <td><?php if($vacancy->is_filled==1): ?> <?php echo e('Yes'); ?> <?php else: ?><?php echo e('No'); ?><?php endif; ?></td>
                                <td class="actions" id="status_div_<?php echo e($vacancy->id); ?>"><?php if($vacancy->status==0): ?> <a onclick="fnStatusChange(<?php echo e($vacancy->id); ?>,<?php echo e($vacancy->status); ?>)"><i class="btn btn-sm btn-warning waves-effect icon fa-eye-slash" aria-hidden="true"   title="Make Active"></i></a> <?php else: ?> <a onclick="fnStatusChange(<?php echo e($vacancy->id); ?>,<?php echo e($vacancy->status); ?>)"><i class="btn btn-sm btn-success waves-effect icon fa-eye" aria-hidden="true" title="Make Inactive"></i></a> <?php endif; ?></td>
                                <td class="actions"><?php if($vacancy->is_filled!=1): ?> <a onClick="fnEditVacancy(<?php echo e($vacancy->id); ?>)"><i class="btn btn-sm btn-primary waves-effect icon fa-edit" aria-hidden="true" title="Edit"></i></a><a onClick="fnDelete(<?php echo e($vacancy->id); ?>)"><i class="btn btn-sm btn-danger waves-effect icon fa-close" aria-hidden="true" title="Delete"></i></a><?php endif; ?></td>
                            </tr>                            
          ...
          <div class="row row-lg col-xs-12">            
            <div class="col-xs-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="vacant_position" name="vacant_position" placeholder="Vacant Position" value="<?php echo e(old('vacant_position')!='' ? old('vacant_position') : ((isset($vacancy_details) && $vacancy_details->vacant_position!='') ? $vacancy_details->vacant_position : '')); ?>">               
              </div>
              <div id="vacant_position_err"></div> 
              <div class="form-group">
                <label class="example-title">Instead of whom&nbsp;<span class="required_filed">*</span></label>
                <input type="text" class="form-control" id="instead_of_whom" name="instead_of_whom" placeholder="Instead of whom" value="<?php echo e(old('instead_of_whom')!='' ? old('instead_of_whom') : ((isset($vacancy_details) && $vacancy_details->instead_of_whom!='') ? $vacancy_details->instead_of_whom : '')); ?>">               
              </div>
              <div id="instead_of_whom_err"></div>    
                         
              <div class="form-group">
                <label class="example-title">Description&nbsp;<span class="required_filed">*</span></label>
                <textarea class="form-control" id="description" name="description" placeholder="Description"><?php echo e(old('description')!='' ? old('description') : ((isset($vacancy_details) && $vacancy_details->description!='') ? $vacancy_details->description : '')); ?></textarea>               
              </div>
