					...
					<div class="page-aside-section">
						<div class="list-group">
							<a class="list-group-item" href="javascript:void(0)" onclick="cat('A')">
								<span class="item-right"><?php echo e(count($direct)); ?></span><i class="icon wb-inbox" aria-hidden="true"></i>Direct Reports
							</a>
						</div>
					</div>
					<div class="page-aside-section">
							...
							<div class="list-group" style="margin-bottom: 1px;">
								<h5>
									<a class="list-group-item " href="javascript:void(0)" onclick="cat('M');">
										<span class="item-right"><?php echo e(countsex($data, 'M')); ?></span><i class="fa fa-male" aria-hidden="true"></i> Male
									</a>
								</h5>
							</div>
							<div class="list-group">
								<h5>
									<a class="list-group-item " href="javascript:void(0)" onclick="cat('F');">
										<span class="item-right"><?php echo e(countsex($data, 'F')); ?></span><i class="fa fa-female" aria-hidden="true"></i> Female
									</a>
								</h5>
							</div>
						</div>
			...
			<table class="table table-condensed" id="directempstable">
				...
				<tbody id="directempsbody">
					...
					<tr>
						...
						<td height="10">
							<img class="img-circle img-bordered img-bordered-primary" alt="avatar" src="<?php echo e(asset('upload')); ?>/<?php echo e($emp->image); ?>" style="width: 50px;height: 50px;">
							<?php echo e($emp->name); ?>
						...
						<td height="10">
							<button type="button" class="btn btn-floating btn-success btn-sm" title="L.M. Goal" onclick="url('/lm/objectives_a?isemp=<?php echo e($emp->id); ?>')">
								<i class="icon wb-pencil" aria-hidden="true"></i>
							</button>
							<button type="button" class="btn btn-floating btn-danger btn-sm" title="Rate Employee" onclick="url('/lm/rate?isemp=<?php echo e($emp->id); ?>')">
...
<?php echo $__env->make('layouts.appd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>