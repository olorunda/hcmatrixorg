		...
		<div class="ribbon ribbon-clip ribbon-reverse ribbon-success" id="profribbon">
			...
			<div id="professional">
				...
				<form autocomplete="off">
					<input type="hidden" name="_prof_csrf" id="_prof_csrf" value="<?php echo e(csrf_token()); ?>">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="panel-group" id="professionalaccordion" aria-multiselectable="true" role="tablist">
								<?php $__currentLoopData = $profs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prof): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
								<div class="panel">
									<div class="panel-heading" id="$profD<?php echo e($prof->id); ?>" role="tab">
										<a class="panel-title" data-toggle="collapse" href="#profDataLnk<?php echo e($prof->id); ?>" data-parent="#professionalaccordion" aria-expanded="false" aria-controls="profDataLnk{$prof->id}}">
											<?php echo e($prof->body); ?>

										</a>
									</div>
								</div>
								<div class="panel-collapse collapse" id="profDataLnk<?php echo e($prof->id); ?>" aria-labelledby="profD<?php echo e($prof->id); ?>" role="tabpanel">
									<div class="panel-body">
										<div class="row row-lg">
											<div class="col-md-12" style="display: none;" id="profedited<?php echo e($prof->id); ?>">
												<div class="col-md-12">
											...
											<div class="col-md-12" style="display: none;" id="profeditederr<?php echo e($prof->id); ?>">
												<div class="col-md-12">
											...
											<div class="col-md-12">
												<div class="col-md-12">
													<div class="form-group form-material floating" data-plugin="formMaterial">
														<input type="text" class="form-control" name="bodyname" id="edit_bodyname<?php echo e($prof->id); ?>" value="<?php echo e($prof->body); ?>">
														<label class="floating-label">Name of Organisation/Body</label>
													</div>
												</div>
											</div>
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="form-group form-material floating" data-plugin="formMaterial">
														<input type="text" class="form-control" name="edit_date_joined_body" id="edit_date_joined_body<?php echo e($prof->id); ?>" data-plugin="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo e($prof->date_joined); ?>">
														<label class="floating-label">Date Joined</label>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group form-material floating" data-plugin="formMaterial">
														<input type="text" class="form-control" name="edit_date_left_body" id="edit_date_left_body<?php echo e($prof->id); ?>" data-plugin="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo e($prof->till); ?>">
														<label class="floating-label">Till</label>
													</div>
												</div>
											</div>
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">Membership Mode</label>
														<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="edit_org_membership_type<?php echo e($prof->id); ?>">
															<?php for($mi = 1; $mi <= count($modes); $mi++): ?>
															<?php if($prof->mode == $mi): ?>
															<option selected="selected" value="<?php echo e($mi); ?>"><?php echo e($modes[$mi]); ?></option>
															<?php else: ?>
															<option value="<?php echo e($mi); ?>"><?php echo e($modes[$mi]); ?></option>
															<?php endif; ?>
															<?php endfor; ?>
														</select>
													</div>
												...
												<div class="col-md-6">
													<div class="form-group form-material floating" data-plugin="formMaterial">
														<input type="text" class="form-control" name="edit_org_number" id="edit_org_number<?php echo e($prof->id); ?>" value="<?php echo e($prof->prof_number); ?>">
											...
											<div class="col-md-12">
												<div class="col-md-12">
													<button type="button" class="btn btn-success" onclick="updateProf(<?php echo e($prof->id); ?>)"><i class="icon wb-check-circle"></i> Save changes</button>
													<button type="button" class="btn btn-danger" onclick="deleteProf(<?php echo e($prof->id); ?>)"><i class="icon ion-ios-trash"></i> Delete</button>
												</div>
											</div>
										</div>
									</div>
