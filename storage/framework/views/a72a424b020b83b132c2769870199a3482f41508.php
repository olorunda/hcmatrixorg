	...
	<div class="ribbon ribbon-clip ribbon-reverse ribbon-success" id="empribbon">
		...
		<div id="employement">
			...
			<form autocomplete="off">
				<input type="hidden" name="_emp_token" id="_emp_token" value="<?php echo e(csrf_token()); ?>">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="panel-group" id="employementaccordion" aria-multiselectable="true" role="tablist">
							...
							<div class="panel">
								<div class="panel-heading" id="$empD<?php echo e($emp->id); ?>" role="tab">
									<a class="panel-title" data-toggle="collapse" href="#empDataLnk<?php echo e($emp->id); ?>" data-parent="#employementaccordion" aria-expanded="false" aria-controls="empDataLnk{$emp->id}}">
										<?php echo e($emp->organization); ?>

									</a>
								</div>
							</div>
							<div class="panel-collapse collapse" id="empDataLnk<?php echo e($emp->id); ?>" aria-labelledby="empD<?php echo e($emp->id); ?>" role="tabpanel">
								<div class="panel-body">
									<div class="row row-lg">
										<div class="col-md-12" style="display: none;" id="empedited<?php echo e($emp->id); ?>">
											<div class="col-md-12">
										...
										<div class="col-md-12" style="display: none;" id="empeditederr<?php echo e($emp->id); ?>">
											<div class="col-md-12">
										...
										<div class="col-md-6">
											<div class="form-group form-material floating" data-plugin="formMaterial">
												<input type="text" class="form-control" name="edit_orgname<?php echo e($emp->id); ?>" id="edit_orgname<?php echo e($emp->id); ?>" value="<?php echo e($emp->organization); ?>">
												<label class="floating-label">Name of Organisation</label>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-material floating" data-plugin="formMaterial">
												<input type="text" class="form-control" name="edit_position" id="edit_position<?php echo e($emp->id); ?>" value="<?php echo e($emp->position); ?>">
												<label class="floating-label">Position Held</label>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-material floating" data-plugin="formMaterial">
												<input type="text" class="form-control" name="edit_dateemp" id="edit_dateemp<?php echo e($emp->id); ?>" data-plugin="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo e($emp->start_date); ?>">
												<label class="floating-label">Date Employed</label>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-material floating" data-plugin="formMaterial">
												<input type="text" class="form-control" name="edit_dateemptill" id="edit_dateemptill<?php echo e($emp->id); ?>" data-plugin="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo e($emp->end_date); ?>">
												<label class="floating-label">Till</label>
											</div>
										</div>
										<div class="col-md-12">
											<button type="button" class="btn btn-success" onclick="updateEmp(<?php echo e($emp->id); ?>)"><i class="icon wb-check-circle"></i> Save changes</button>
											<button type="button" class="btn btn-danger" onclick="deleteEmp(<?php echo e($emp->id); ?>)"><i class="icon ion-ios-trash"></i> Delete</button>
										</div>
									</div>
								</div>
							</div>
