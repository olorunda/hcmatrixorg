		...
		<div id="correspondence">
			...
			<div id="correspondence">
				...
				<form autocomplete="off">
					<input type="hidden" name="_corr_csrf" id="_corr_csrf" value="<?php echo e(csrf_token()); ?>">
			...
			<div class="modal-body">
				<div class="row row-lg">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="form-group form-material floating" data-plugin="formMaterial">
								<input type="text" class="form-control" name="edit_city" id="edit_city" value="<?php echo e($corrs->city); ?>">
								<label class="floating-label">City*</label>
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="col-md-12">
						<div class="col-md-12">
							<div class="form-group form-material floating" data-plugin="formMaterial">
								<textarea class="form-control" rows="3" name="edit_addr" id="edit_addr"><?php echo e($corrs->street); ?></textarea>
								<label class="floating-label">Address</label>
							</div>
						</div>
					</div>
