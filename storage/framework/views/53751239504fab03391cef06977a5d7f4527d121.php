<?php echo $__env->make('layouts.header', ['page_title' => 'All Employee Leave Details'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <!-- Page -->
  <div class="page">
                      ...
                      <tbody> 
                           ...
                           <?php $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>                            
                            <tr> 
                                ...
                                <td><?php echo e($leave->emp_name); ?></td>
                                <td><?php echo e($leave->emp_num); ?></td>
                                ...
                                <td id="status_div_<?php echo e($leave->id); ?>" class="actions">
                                  <?php if($leave->leave_status==Config::get('constants.apply_leave_status.APPLIED')): ?>
                                    <a onclick="fnStatusChange(<?php echo e($leave->id); ?>,<?php echo e($leave->leave_status); ?>)"><i class="btn btn-sm btn-warning waves-effect icon fa-exclamation-circle" aria-hidden="true" title="Applied"></i></a>
                                  <?php elseif($leave->leave_status==Config::get('constants.apply_leave_status.REJECTED')): ?>
                                    <a onclick="fnStatusChange(<?php echo e($leave->id); ?>,<?php echo e($leave->leave_status); ?>)"><i class="btn btn-sm btn-danger waves-effect icon fa-close" aria-hidden="true" title="Rejected"></i></a>
                                  <?php elseif($leave->leave_status==Config::get('constants.apply_leave_status.APPROVED')): ?>
                                    <a onclick="fnStatusChange(<?php echo e($leave->id); ?>,<?php echo e($leave->leave_status); ?>)"><i class="btn btn-sm btn-success waves-effect icon fa-check" aria-hidden="true" title="Approved"></i><a/>
