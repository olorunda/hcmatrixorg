		...
		<div class="col-md-12 col-xs-12">
			<div class="panel panel-bordered panel-dark">
				...
				<div class="panel-body">
					...
					<img class="img-circle img-bordered img-bordered-primary" id="avatar<?php echo e($direct->id); ?>" width="80" height="80" src="<?php echo e(asset('upload')); ?>/<?php echo e($direct->image); ?>" style="cursor: pointer;" title="<?php echo e($direct->name); ?>" data-toggle="modal" data-target="#manageEmployeeModal<?php echo e($direct->id); ?>">
				...
				<div class="modal-body">
					<div class="tab-content">
						<div class="tab-pane active" id="headingDistinct1<?php echo e($direct->id); ?>" role="tabpanel">
							<div class="row">
								<div class="col-md-3">
									<img class="img-thumbnail img-bordered img-default" src="<?php echo e(asset('upload')); ?>/<?php echo e($direct->image); ?>" align="left" style="height: 100%;">
								</div>
								<div class="col-md-9">
