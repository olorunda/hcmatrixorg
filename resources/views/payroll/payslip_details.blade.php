          ...
          <form class="form-horizontal" role="form" method="POST" action="{{ url('update_payslip_details') }}" enctype="multipart/form-data">
            ...
            <div class="col-xs-6">              
                <div class="form-group">
                  ...
                  @if(isset($payslip_details) && $payslip_details->payslip_logo!='' && file_exists(public_path('payslip_logo').'/'.$payslip_details->payslip_logo)) <br/><div id="payslip_logo_img"><img src="{{asset('payslip_logo')}}/<?php echo $payslip_details->payslip_logo; ?>" width="100" border="0"></div> @endif
