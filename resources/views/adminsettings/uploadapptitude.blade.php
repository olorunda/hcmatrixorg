...
$(function (){
	...
	**/
			$('#savetestsett').click(function(){
							...
							$.get('{{url('test/setting')}}?duration='+duration+'&quesnum='+quesnum,function(data,status,xhr){
...
<div class="panel" style="margin-bottom: 4px;">
  ...
  <div  class="ribbon ribbon-clip ribbon-danger">
    ...
    <div class="panel-group panel-group-simple" id="siteMegaAccordion" aria-multiselectable="true" role="tablist">
      <div class="panel">
        ...
        <div class="panel-collapse collapse" id="siteMegaCollapseThree{{$question->id}}" aria-labelledby="siteMegaAccordionHeadingThree" role="tabpanel">
          <div class="panel-body">
            <div class="row">
              <div class="col-md-12 col-xs-12">
                ...
                <ul>
                  <li>
				<span class=" @if($question->correctoption==1) text-success @endif">1) {{$question->option1}}</span>
                  </li>
                </ul>
              </div>
              <div class="col-md-12 col-xs-12">
                ...
                <ul>
                  <li>
				  <span class=" @if($question->correctoption==2) text-success @endif">2) {{$question->option2}}</span>
                  </li>
              ...
              <div class="col-md-12 col-xs-12">
                ...
                <ul>
                  <li>
                  <span class=" @if($question->correctoption==3) text-success @endif"> 3) {{$question->option3}} </span>
                  </li>
                </ul>
              </div>
              <div class="col-md-12 col-xs-12">
                ...
                <ul>
                  <li><span class=" @if($question->correctoption==4) text-success @endif">4) {{$question->option4}}
				  </span>
				  </li>
                </ul>
              </div>
 ...
 <div id="myModal{{$question->id}}" class="modal modal-success fade" role="dialog" >
