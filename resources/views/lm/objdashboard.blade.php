    ...
    <li data-plugin="appear" data-animate="scale-up">
      <div class="">
        <div class="category">
          ...
          <button type="button" class="btn btn-outline btn-info ladda-button" data-style="expand-left" data-plugin="ladda" data-type="progress" onclick="url('/lm/goals?type=pilot');">
    ...
    <li data-plugin="appear" data-animate="slide-right">
      <div class="">
        <div class="category">
          ...
          <h4 class="text-warning">Line Manager Objectives</h4>
          ...
          <button type="button" class="btn btn-outline btn-warning ladda-button" data-style="expand-left" data-plugin="ladda" data-type="progress" onclick="url('/lm/objectives_c')">
            <span class="ladda-label"><i class="icon wb-plus m-r-10" aria-hidden="true"></i>More</span>
          </button>
        </div>
      </div>
    ...
    <li data-plugin="appear" data-animate="slide-top">
      <div class="">
        <div class="category">
          ...
          <button type="button" class="btn btn-outline btn-success ladda-button" data-style="expand-left" data-plugin="ladda" data-type="progress" onclick="url('/lm/goals?type=pilot');">
            <span class="ladda-label"><i class="icon wb-plus m-r-10" aria-hidden="true"></i>More</span>
          </button>
        </div>
      </div>
    ...
    <li data-plugin="appear" data-animate="slide-bottom">
      <div class="">
        <div class="category">
          ...
          <button type="button" class="btn btn-outline btn-primary ladda-button" data-style="expand-left" data-plugin="ladda" data-type="progress" onclick="url('/lm/goals?type=pilot');">
            <span class="ladda-label"><i class="icon wb-plus m-r-10" aria-hidden="true"></i>More</span>
          </button>
        </div>
      </div>
