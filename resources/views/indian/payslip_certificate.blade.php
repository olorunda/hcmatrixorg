            ...
            <div class="page-content">
                <div class="panel">        
                    <div class="panel-body container-fluid">
                        ...
                        <div style="text-align:center"><img src="{{Config::get("constants.site_path.absolute_path").'public/payslip_logo/'.$certificate_details['settings']->payslip_logo}}" width="150" borer="0"></div>
