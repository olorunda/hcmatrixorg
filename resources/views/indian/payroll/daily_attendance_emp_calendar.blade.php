              ...
              <div class="modal-body">
                <div class="form-group row">
                    <div class="col-xs-12 col-md-3">
                        ...
                        <label id="edit_att_title">Present</label>
                    </div>
                    <div class="col-xs-12 col-md-3">
                        <label><b>Attendance Date:</b></label>
                        <label id="edit_att_date">Attendance Date</label>
                    </div>
                    <div class="col-xs-12 col-md-3">
                        <label><b>Attendance In-time:</b></label>
                        <label id="edit_att_intime">Attendance In-time</label>
                    </div> 
                    <div class="col-xs-12 col-md-3">
                        <label><b>Attendance Out-time:</b></label>
                        <label id="edit_att_outtime">Attendance Out-time</label> 
                    </div>          
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="input-append bootstrap-timepicker-component">Enter In-time : &nbsp;
                    <input type="text" name="intime" class="timepicker-default input-small" value="9:00 am"/>     
                    <span class="add-on">              
                    </span>
                  </div>
