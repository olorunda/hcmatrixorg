            ...
            <div class="panel-body nav-tabs-animate nav-tabs-horizontal" data-plugin="tabs">
              ...
              <div class="tab-content">
				...
				<div class="form-group">
                  <input type="text" class="form-control" value="{{Auth::user()->name}}" placeholder="Full Name" disabled>
                </div>
				<div class="form-group">
                  <input type="text" id="email" class="form-control" value="{{Auth::user()->email}}" placeholder="Email Address">
                </div>
				<div class="form-group">
                  <input type="text" class="form-control" value="{{Auth::user()->dob}}" disabled placeholder="Date of Birth">
                </div>
				<div class="form-group">
                  <input type="text" value="{{Auth::user()->sex}}" class="form-control" placeholder="Sex" disabled>
                </div>
				<div class="form-group">
                  <input type="text" class="form-control" value="{{Auth::user()->facebook}}" id="facebook" placeholder="Facebook Profile Url">
                </div>
				<div class="form-group">
                  <input type="text" class="form-control" value="{{Auth::user()->twitter}}" id="twitter" placeholder="Twitter Profile Url">
                </div>
				<div class="form-group">
                  <input type="text" class="form-control" value="{{Auth::user()->instagram}}" id="instagram" placeholder="Instagram Profile Url">
                </div>
				<div class="form-group">
                  <input type="text" class="form-control" value="{{Auth::user()->dribbble}}" id="dribble" placeholder="Dribble Profile Url">
                </div>
