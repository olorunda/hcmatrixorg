...
function clickToday() {
 ...
 $(function(){
   ...
   $.get('{{url('leave')}}/statistics',function(data,status,xhr){
 linkinfo= Morris.Bar({
...
<div class="row" data-plugin="matchHeight" data-by-row="true">
    ...
    <div class="card card-shadow">
      <div class="card-block bg-white p-20">
        ...
        <div class="content-text text-xs-center m-b-0">
          ...
          <span class="font-size-40 font-weight-100">{{$count['holscount']}}</span>
    ...
    <div class="card card-shadow">
      <div class="card-block bg-white p-20">
        ...
        <div class="content-text text-xs-center m-b-0">
          ...
          <span class="font-size-40 font-weight-100">{{$count['totalleave']}}</span>
  ...
  <div class="col-xl-3 col-md-6 col-xs-12 info-panel">
    <div class="card card-shadow">
      <div class="card-block bg-white p-20">
        <button type="button" onclick="url('{{url('manage/absence')}}')" class="btn btn-floating btn-sm btn-success" data-toggle="modal" data-target="#requests">
        ...
        <div class="content-text text-xs-center m-b-0">
          ...
          <span class="font-size-40 font-weight-100">{{$count['request']}}</span>
    ...
    <div class="card card-shadow">
      <div class="card-block bg-white p-20">
        ...
        <div class="content-text text-xs-center m-b-0">
          ...
          <span class="font-size-40 font-weight-100">{{$count['leavetype']}}</span>
  ...
  <!-- second Row -->
    ...
    <div class="card">
              <div class="card-block">
                <h4 class="card-title"><i class="wb-graph-up" ></i>&nbsp;&nbsp;Absence Request Statistics For @if(session()->has('FY')) {{session('FY')}} @else {{date('Y')}}  @endif</h4>
