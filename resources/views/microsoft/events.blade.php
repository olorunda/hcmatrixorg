                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
					   ...
					   @endif
						...
						<textarea class="form-control {{$hide}}"   placeholder="please enter the emailaddress of the attendees separated bt a comma e.g test@email.com,test2@email.com" id="attendees"></textarea><br>
						<b>Location:</b><br> 
