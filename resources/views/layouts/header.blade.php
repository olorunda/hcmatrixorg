...
<head>
 ...
 <link rel="stylesheet" href="{{ URL::asset('classic/global/css/bootstrap.min.css') }}" />
  ...
  <link rel="shortcut icon" href="{{asset('assets/images/favicon.ico')}}">  <!-- Stylesheets -->
  <link rel="stylesheet" href="{{ URL::asset('classic/global/css/bootstrap.min.css') }}">
  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        <img class="navbar-brand-logo" src="{{ URL::asset('assets/images/logo.png') }}" title="HCMatrix">
