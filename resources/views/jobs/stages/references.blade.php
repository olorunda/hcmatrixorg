		...
		<div class="ribbon ribbon-clip ribbon-reverse ribbon-success" id="refribbon">
			...
			<div id="references">
				...
				<form autocomplete="off">
					<input type="hidden" name="_ref_token" id="_ref_token" value="{{csrf_token()}}">
							...
							<div class="row row-lg">
								<div class="col-md-12">
									...
									<div class="panel-group" id="referencesaccordion" aria-multiselectable="true" role="tablist">
										@foreach($refs as $ref)
										<div class="panel">
											<div class="panel-heading" id="$refEd{{$ref->id}}" role="tab">
												<a class="panel-title" data-toggle="collapse" href="#refEdData{{$ref->id}}" data-parent="#referencesaccordion" aria-expanded="false" aria-controls="refEdData{$ref->id}}">
													{{ $ref->ref_name }}
												</a>
											</div>
										</div>
										<div class="panel-collapse collapse" id="refEdData{{$ref->id}}" aria-labelledby="refEd{{$ref->id}}" role="tabpanel">
											<div class="panel-body">
												<div class="row row-lg">
													<div class="col-md-12" style="display: none;" id="refedited{{$ref->id}}">
														<div class="col-md-12">
													...
													<div class="col-md-12" style="display: none;" id="refeditederr{{$ref->id}}">
														<div class="col-md-12">
													...
													<div class="col-md-12">
														<div class="col-md-12">
															<div class="form-group">
																<label class="control-label">Title*</label>
																<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="edit_ref_title{{$ref->id}}">
																	@for($i = 1; $i <= count($refTitle); $i++)
																	@if($ref->ref_title == $i)
																	<option selected="selected" value="{{$i}}">{{$refTitle[$i]}}</option>
																	@else
																	<option value="{{$i}}">{{$refTitle[$i]}}</option>
																	@endif
																	@endfor
																</select>
															</div>
													...
													<div class="col-md-12">
														<div class="col-md-6">
															<div class="form-group form-material floating" data-plugin="formMaterial">
																<input type="text" class="form-control" name="edit_ref_name" id="edit_ref_name{{$ref->id}}" value="{{$ref->ref_name}}">
																<label class="floating-label">Name</label>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group form-material floating" data-plugin="formMaterial">
																<input type="text" class="form-control" name="edit_ref_prof" id="edit_ref_prof{{$ref->id}}" value="{{$ref->ref_prof}}">
																<label class="floating-label">Profession</label>
															</div>
														</div>
													</div>
													<div class="col-md-12">
														<div class="col-md-12">
															<div class="form-group form-material floating" data-plugin="formMaterial">
																<textarea class="form-control" name="edit_ref_addr" id="edit_ref_addr{{$ref->id}}">{{$ref->ref_addr}}</textarea>
																<label class="floating-label">Address</label>
															</div>
														</div>
													</div>
													<div class="col-md-12">
														<div class="col-md-6">
															<div class="form-group form-material floating" data-plugin="formMaterial">
																<input type="text" class="form-control" name="edit_ref_city" id="edit_ref_city{{$ref->id}}" value="{{$ref->ref_city}}">
																<label class="floating-label">City</label>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group">
																<label class="control-label">State*</label>
																<select class="form-control" data-plugin="select2" data-allow-clear="true" id="edit_ref_state{{$ref->id}}">
																	@foreach($states as $state)
																	@if($ref->ref_state_id == $state->id)
													...
													<div class="col-md-12">
														<div class="col-md-12">
															<div class="form-group">
																<label class="control-label">country*</label>
																<select class="form-control" data-plugin="select2" data-allow-clear="true" id="edit_ref_country{{$ref->id}}">
																	@foreach($countries as $country)
																	@if($ref->ref_country_id == $country->id)
													...
													<div class="col-md-12">
														<div class="col-md-6">
															<div class="form-group form-material floating" data-plugin="formMaterial">
																<input type="email" class="form-control" name="edit_ref_mail" id="edit_ref_mail{{$ref->id}}" value="{{$ref->ref_email}}">
																<label class="floating-label">E-Mail</label>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group form-material floating" data-plugin="formMaterial">
																<input type="phone" class="form-control" name="edit_ref_phone" id="edit_ref_phone{{$ref->id}}" value="{{$ref->ref_phone}}">
																<label class="floating-label">Phone</label>
															</div>
														</div>
													</div>
													<div class="col-md-12">
														<div class="col-md-12">
															<button type="button" class="btn btn-success" onclick="updateRef({{$ref->id}})"><i class="icon wb-check-circle"></i> Save changes</button>
															<button type="button" class="btn btn-danger" onclick="deleteRef({{$ref->id}})"><i class="icon ion-ios-trash"></i> Delete</button>
														</div>
													</div>
												</div>
											</div>
