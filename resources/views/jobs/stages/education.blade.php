	...
	<div style="display: none;" id="educationContainer">
		...
		<div id="education">
			...
			<form autocomplete="off">
				<input type="hidden" name="_sec_token" id="_sec_token" value="{{csrf_token()}}">
		...
		<form autocomplete="off">
			<input type="hidden" name="_inst_token" id="_inst_token" value="{{csrf_token()}}">
			...
			<div class="form-group">
				...
				<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="inst_degree">
					...
					<option value="{{$degindex}}">{{$degrees[$degindex]}}</option>
					@endfor
				</select>
			</div>
			<div class="form-group">
				...
				<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="inst_degree_class">
					@for($gradeindex = 1; $gradeindex <= count($grades); $gradeindex++)
					<option value="{{$gradeindex}}">{{$grades[$gradeindex]}}</option>
					@endfor
				</select>
			</div>
					...
					<div class="row row-lg">
						<div class="col-md-12">
							...
							<div class="panel-group" id="secondaryaccordion" aria-multiselectable="true" role="tablist">
								@foreach($eds as $ed)
								<div class="panel">
									<div class="panel-heading" id="$secEd{{$ed->id}}" role="tab">
										<a class="panel-title" data-toggle="collapse" href="#secEdData{{$ed->id}}" data-parent="#secondaryaccordion" aria-expanded="false" aria-controls="secEdData{$ed->id}}">
											{{ $ed->name }}
										</a>
									</div>
								</div>
								<div class="panel-collapse collapse" id="secEdData{{$ed->id}}" aria-labelledby="secEd{{$ed->id}}" role="tabpanel">
									<div class="panel-body">
										<div class="row row-lg">
											<div class="col-md-12" style="display: none;" id="ededited{{$ed->id}}">
												<div class="col-md-12">
											...
											<div class="col-md-12" style="display: none;" id="ededitederr{{$ed->id}}">
												<div class="col-md-12">
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="form-group form-material floating" data-plugin="formMaterial">
														<input type="text" class="form-control" name="edit_schname" id="edit_schname{{$ed->id}}" value="{{$ed->name}}">
														<label class="floating-label">Name of School*</label>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">Year of Entry*</label>
														<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="edit_entry_year{{$ed->id}}">
															<option value="1980">1980</option>
															@for($i = 1981; $i <= date('Y'); $i++)
															@if($ed->start_year == $i)
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">Year Completed*</label>
														<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="edit_seccompletedyear{{$ed->id}}">
															<option value="1980">1980</option>
															@for($i = 1981; $i <= date('Y'); $i++)
															@if($ed->end_year == $i)
															<option selected="selected" value="{{$i}}">{{$i}}</option>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">Degree Obtained*</label>
														<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="edit_secdegree{{$ed->id}}">
															@if(count($gradeDocs) > 0)
															@foreach($gradeDocs as $grade)
															@if($ed->degree == $grade->id)
															<option selected="selected" value="{{$grade->id}}">{{$grade->docname}}</option>
															@else
															<option value="{{$grade->id}}">{{$grade->docname}}</option>
															@endif
															@endforeach
											...
											<div class="col-md-12">
												<div class="col-md-12">
													<button type="button" class="btn btn-success" onclick="updateSec({{$ed->id}})"><i class="icon wb-check-circle"></i> Save changes</button>
													<button type="button" class="btn btn-danger" onclick="deleteSec({{$ed->id}})"><i class="icon ion-ios-trash"></i> Delete</button>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="panel-group" id="institutionaccordion" aria-multiselectable="true" role="tablist">
								@foreach($edIs as $is)
								<div class="panel">
									<div class="panel-heading" id="$isEd{{$is->id}}" role="tab">
										<a class="panel-title" data-toggle="collapse" href="#isEdData{{$is->id}}" data-parent="#institutionaccordion" aria-expanded="false" aria-controls="isEdData{$is->id}}">
											{{ $is->name }}
										</a>
									</div>
								</div>
								<div class="panel-collapse collapse" id="isEdData{{$is->id}}" aria-labelledby="isEd{{$is->id}}" role="tabpanel">
									<div class="panel-body">
										<div class="row row-lg">
											<div class="col-md-12" style="display: none;" id="isedited{{$is->id}}">
												<div class="col-md-12">
													<div class="alert alert-success alert-dismissible">
														<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
														<strong>Success! </strong> Record Updated.
											...
											<div class="col-md-12" style="display: none;" id="iseditederr{{$is->id}}">
												<div class="col-md-12">
													<div class="alert alert-danger alert-dismissible">
														<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
														<strong>Failed! </strong> Record was not updated. Please try again.
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">country*</label>
														<select class="form-control" data-plugin="select2" data-allow-clear="true" id="edit_is_country{{$is->id}}">
															@foreach($countries as $country)
															@if($is->country_id == $country->id)
												...
												<div class="col-md-6">
													<div class="form-group form-material floating" data-plugin="formMaterial">
														<input type="text" class="form-control" name="editisname" id="edit_is_name{{$is->id}}" value="{{$is->name}}">
														<label class="floating-label">Name of Institution*</label>
													</div>
												</div>
											</div>
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="form-group form-material floating" data-plugin="formMaterial">
														<input type="text" class="form-control" name="editiscourse" id="edit_is_course{{$is->id}}" value="{{$is->course}}">
														<label class="floating-label">Course of Study*</label>
														<label class="text-danger" id="inst_course_err"></label>
													</div>
												</div>
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">Degree Obtained*</label>
														<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="edit_is_degree{{$is->id}}">
															@for($degindex = 1; $degindex <= count($degrees); $degindex++)
															@if($is->degree == $degindex)
															<option selected="selected" value="{{$degindex}}">{{$degrees[$degindex]}}</option>
															@else
															<option value="{{$degindex}}">{{$degrees[$degindex]}}</option>
															@endif
															@endfor
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">Degree Class*</label>
														<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="edit_grade{{$is->id}}">
															@for($gradeindex = 1; $gradeindex <= count($grades); $gradeindex++)
															@if($is->degree_class == $gradeindex)
															<option selected="selected" value="{{$gradeindex}}">{{$grades[$gradeindex]}}</option>
															@else
															<option value="{{$gradeindex}}">{{$grades[$gradeindex]}}</option>
															@endif
															@endfor
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">Year of Entry*</label>
														<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="edit_is_start{{$is->id}}">
															<option value="1980">1980</option>
															@for($i = 1981; $i <= date('Y'); $i++)
															@if($is->start_year == $i)
															<option selected="selected" value="{{$i}}">{{$i}}</option>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">Year Completed*</label>
														<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="edit_is_end{{$is->id}}">
															<option value="1980">1980</option>
															@for($i = 1981; $i <= date('Y'); $i++)
															@if($is->end_year == $i)
															<option selected="selected" value="{{$i}}">{{$i}}</option>
											...
											<div class="col-md-12">
												<div class="col-md-12">
													<button type="button" class="btn btn-success" onclick="updateInst({{$is->id}})"><i class="icon wb-check-circle"></i> Save changes</button>
													<button type="button" class="btn btn-danger" onclick="deleteInst({{$is->id}})"><i class="icon ion-ios-trash"></i> Delete</button>
												</div>
											</div>
										</div>
									</div>
