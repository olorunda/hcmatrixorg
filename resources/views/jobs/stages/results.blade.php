					...
					<div class="modal-body">
						<div class="row row-lg">
							...
							<div class="col-md-12">
								<div class="col-md-4">
									<select class="form-control" required="required" data-plugin="select2" data-allow-clear="true" id="viewmod">
										...
										<option value="{{ $takens->exam_id }}">{{ $name['docname'] }}</option>
										@endforeach
										@endif
									</select>
								</div>
							...
							<div class="col-md-12">
								<div class="col-md-6">
									<div class="form-group form-material floating" data-plugin="formMaterial">
										<select class="form-control editsub"  id="edit_subject{{$subjectCounter}}">
											@if(count($subjects) > 0)
											@foreach($subjects as $subject)
											<option value="{{$subject->id}}">{{$subject->subject}}</option>
											@endforeach
								...
								<div class="col-md-6">
									<div class="form-group form-material floating" data-plugin="formMaterial">
										<select class="form-control floating editgrade" id="edit_grade_olevel{{$subjectCounter}}">
											@if(count($grades) > 0)
											@foreach($grades as $grade)
											<option value="{{$grade->id}}">{{$grade->grade}}</option>
											@endforeach
