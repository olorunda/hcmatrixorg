...
(function($){
  ...
  $(function() {
	...
	"id": "1",
      ...
      "relationship": "111",
      'children': [
        { 'id': '2','name': 'Tie Hua', 'title': 'senior engineer', 'relationship': '111' },
        { 'id': '3','name': 'Hei Hei', 'title': 'senior engineer', 'relationship': '111' }
      ]
    };
	
    var ajaxURLs = {
      'children': '/orgchart/babyme/',
      'parent': '/orgchart/mamame/',
      'siblings': function(nodeData) {
        return '/orgchart/generations/' + nodeData.id;
      },
